...
def make_admixture(
    ...
    fluxes = utility_functions.mags_to_fluxes(mags, zero_points)
    lib_fluxes = utility_functions.mags_to_fluxes(library, zero_points)
    ...
    new_mags = utility_functions.fluxes_to_mags(new_fluxes, zero_points)
